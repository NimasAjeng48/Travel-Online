      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-menu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo site_url('welcome/about2')?>">Transaksi</a></li>
    ...
    <section class="probootstrap_section">
      <div class="container">
              ...
              <p class="probootstrap-author">
                <a href="<?php echo base_url('assets/assets/https://probootstrap.com/')?>" target="_blank">
          </div>
        </div>
      </div>
    </section>
