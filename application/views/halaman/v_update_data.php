          ...
          <div class="card mb-4">
            <div class="card-body">
			  ...
			  <div class="portlet-body form">
					...
					<?php echo form_open('Welcome/ubah_data/'.$hasil->id_penumpang); ?>								
						<div class="form-body">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									<textarea class="form-control" rows="1" placeholder="maskapai" name="maskapai"><?php echo $hasil->nama; ?></textarea>
								</div>
							</div>
                ...
                <div class="col-md-12">
                  <textarea class="form-control" rows="1" placeholder="alamat" name="noHp"><?php echo $hasil->alamat; ?></textarea>
                </div>
              </div>
               ...
               <div class="form-group">
                ...
                <input type="date" name="tanggal" size="50" />
						...
						<?php echo form_close(); ?>	
            <button style="text-decoration: none;" ><a href="<?php echo site_url();?>/welcome/list_data">Kembali</button>
