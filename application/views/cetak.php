    ...
    <section class="probootstrap-cover overflow-hidden relative"  style="background-image: url('<?php echo base_url('assets/assets/images/header.jpg')?>')" data-stellar-background-ratio="0.5" id="section-home">
      ...
      <div class="container">
        <div class="row align-items-center text-center">
          <div class="col-md">
            <h2 class="heading mb-2 display-4 font-light probootstrap-animate">Pesanan</h2>
      ...
      <div class="container">
        <div class="row mb-3">
          <div class="col-md probootstrap-animate">
            <center>
               <h4>ID Penumpang : <?= $id_penumpang?></h4><hr>
               <h4>Nama Lengkap : <?= $nama?></h4><hr>
               <h4>alamat :  <?= $alamat?></h4><hr>
               <h4>noHp :  <?= $noHp?></h4><hr>
               <h4>Asal : <?= $asal?></h4><hr>
               <h4>Tujuan : <?= $tujuan?></h4><hr>
               <h4>Tanggal Keberangkatan : <?= $tanggal?></h4><hr>
