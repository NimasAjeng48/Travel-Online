...
<body >
      ...
      <center>
        ...
        <h3> Username Anda Adalah <?php echo $this->session->userdata('level'); ?></h3><br /><br />
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      ...
      <li class="nav-item active">
            ...
            <li class="nav-item active">
              <a class="nav-link" href="<?php echo site_url('authentication/auth/logout'); ?>">KELUAR</a>
            </li>
          </ul>
        </div>
      </div>
            ...
            <table class="table table-striped table-hover table-bordered">
                        <thead>
                           <tr align="center">
                              ...
                              <th scope="col">Tanggal Keberangkatn</th>
